...
def path_sum_xxiv(root: Optional[TreeNode], target_sum: int) -> List[List[int]]:
    """
...
def test_path_sum_xxiv():
    """Test cases for the binary tree path sum XXIV solution."""
