...
def path_sum_xxx(root: Optional[TreeNode], target_sum: int) -> List[List[int]]:
    """
...
def test_path_sum_xxx():
    """Test cases for the binary tree path sum XXX solution."""
