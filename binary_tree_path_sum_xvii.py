...
def path_sum_xvii(root: Optional[TreeNode], target_sum: int) -> List[List[int]]:
    """
...
def test_path_sum_xvii():
    """Test cases for the binary tree path sum XVII solution."""
