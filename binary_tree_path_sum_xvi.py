...
def path_sum_xvi(root: Optional[TreeNode], target_sum: int) -> List[List[int]]:
    """
    Find all paths that sum to a given value using BFS and DFS with path tracking and memoization.
    ...
    result = []
    memo = {}  # Memoization cache for paths
...
def test_path_sum_xvi():
    """Test cases for the binary tree path sum XVI solution."""
