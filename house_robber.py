def rob(nums: list[int]) -> int:
    """
    Find the maximum amount of money that can be robbed from houses arranged in a line.
    ...
    for i in range(2, len(nums)):
        ...
        # 1. Rob current house + money from house i-2
        # 2. Skip current house and take money from house i-1
